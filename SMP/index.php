                        ...
                        <li class='dropdown user user-menu'>
                            <a href='#' class='dropdown-toggle' data-toggle='dropdown'>
                                ...
                                if ($siswa['foto'] <> '') :
                                    if (!file_exists("foto/fotosiswa/$siswa[foto]")) :
                                        echo "<img src='$homeurl/dist/img/icon_siswa.jpg' class='user-image'   alt='+'>";
                                    else :
                            ...
                            <ul class='dropdown-menu'>
                                <li class='user-header bg-red'>
                                    ...
                                    if ($siswa['foto'] <> '') :
                                        if (!file_exists("foto/fotosiswa/$siswa[foto]")) :
                                            echo "<img src='$homeurl/dist/img/icon_siswa.jpg' class='img-circle' alt='User Image'>";
                                        else :
            ...
            <section class='sidebar'>
                ...
                <div class='user-panel'>
                    <div class='pull-left image'>
                        ...
                        if ($siswa['foto'] <> '') :
                            if (!file_exists("foto/fotosiswa/$siswa[foto]")) :
                                echo "<img src='$homeurl/dist/img/icon_siswa.jpg' class='img'  style='max-width:60px' alt='+'>";
                            else :
                    ...
                    ?>
                        <div class='row'>
                            <div class='col-md-12'>
                                <div class='box box-solid'>
                                    <div class='box-header with-border'>
                                        <h3 class='box-title'><i class="fas fa-file-signature    "></i> Data Hasil Tugas</h3>
                                    </div><!-- /.box-header -->
                                    <div class='box-body'>
                        ...
                        <div class='col-md-12'>
                            <div class='box box-solid'>
                                ...
                                <div class='box-body'>
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            <li class=""><a href="#tab_1" data-toggle="tab" aria-expanded="true">Hasil Tugas</a></li>
        ...
        <footer class='main-footer hidden-xs'>
            <div class='container'>
                <div class='pull-left hidden-xs'>
                    <strong>
                        <span id='end-sidebar'>
                            <h5>Aplikasi E-Learning SMP Negeri 1 Parakan</h5>
                        </span>
                    </strong>
                </div>
        </footer>
