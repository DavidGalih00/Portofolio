...
<head>
    ...
    <title>E-Learning SMP Negeri 1 Parakan</title>

    <!-- Bootstrap core CSS -->
    <style class="anchorjs"></style>
    <link href="<?= $homeurl ?>/dist/bootstrap-4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Favicons -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= $homeurl ?>/dist/img/Logo.png">
    <link rel="icon" type="image/png" sizes="192x192" href="<?= $homeurl ?>/dist/img/Logo.png">
...
<body class="text-center">
    ...
    <form class="form-signin" action="<?= $homeurl ?>/mobile_login.php" method="POST" name="login" style="z-index: 2;">
        <img class="mb-4" src="<?= $homeurl ?>/dist/img/Logo.png" alt="" width="72" height="72">
        <h1 class="h3 mb-3 font-weight-normal text-white">Silahkan Masuk</h1>
        ...
        <p class="mt-4 mb-3 text-muted">1964-2023</p>
    </form>
