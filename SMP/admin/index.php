...
<head>
	...
	<title>E-Learning <?= $setting['aplikasi'] ?></title>
	<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
	<link rel='shortcut icon' href='<?= $homeurl ?>/dist/img/Logo.png' />
    <!-- Favicons -->
    <link rel="manifest" href="<?= $homeurl ?>/dist/pwa/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?= $homeurl ?>/dist/img/Logo.png">
							...
							<ul class='dropdown-menu'>
								<li class='user-header'>
									...
									if ($pengawas['level'] == 'admin') :
										echo "<img src='$homeurl/dist/img/default_admin.png' class='img-circle' alt='User Image'>";
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<?php endif ?>
						<li class='treeview'><a href='?pg=siswa'><i class="fas fa-user-friends side-menu-icon fa-fw   "></i> <span>Siswa</span></a></li>
						...
						<div class='row'>
							...
							<div class="col-md-4">
								<div class="box box-solid">
									...
									<div class="box-body">
										<div class="col-lg-6">
											<h4><b>Selamat Datang di E-Learning SMP N 1 Parakan</b></h4>
											<img src="../dist/img/Logo.png" alt="logo_smp" style='text-align:center; width:200px;' class="col-lg-12">
										</div>
										<div class="col-lg-6">
						...
						if ($ext <> 'xls') {
							...
							for ($i = 2; $i <= $hasildata; $i++) {
								...
								if ($nama <> '') {
									...
									$exec = mysqli_query($koneksi, "INSERT INTO siswa (id_siswa,id_kelas,idpk,nis,no_peserta,nama,level,username,password,foto,server,agama) VALUES ('$id_siswa','$kelas','$pk','$nis','$no_peserta','$nama','$level','$sesi','$ruang','$username','$password','$foto','$server','$agama')");
		...
		<footer class='main-footer hidden-xs'>
			<div class='container'>
				<div class='pull-left hidden-xs'>
					<strong>
						<span id='end-sidebar'>
							<h5>Aplikasi E-Learning SMP N 1 Parakan</h5>
						</span>
					</strong>
				</div>
